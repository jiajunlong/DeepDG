...
import extension.normalization.normalization as myNorm
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, args, num_classes=1000, zero_init_residual=False):
        ...
        self.replace_norm = args.replace_norm
        self.inplanes = 64
        self.args = args
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                # myNorm.Norm(planes * block.expansion),
            )
    ...
    def _replace_norm(self):
        ...
        if self.replace_norm['pre_norm']:
            setattr(self, 'bn1', myNorm.Norm(getattr(self, 'bn1').num_features))
...
if __name__ == '__main__':
    ...
    args = parse.parse_args(['--replace-norm', 'layer=[1,2,3,4]/norm_num=[1,2]'])
    args.norm = 'BN'
    myNorm.setting(args)
    print(args)