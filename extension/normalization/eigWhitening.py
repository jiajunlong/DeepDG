...
class EIGWhitening_Single(torch.nn.Module):
    def __init__(self, num_features, dim=4, eps=1e-3, momentum=0.1, affine=True,
        ...
        # assert dim == 4, 'EIGWhitening is not support 2D'
        self.eps = eps
...
class EIGWhitening(torch.nn.Module):
    def __init__(self, num_features, num_channels=16, dim=4, eps=1e-3, momentum=0.1, affine=True,
        ...
        self.EIGWhitening_Groups = torch.nn.ModuleList(
            [EIGWhitening_Single(num_features=self.num_channels, eps=eps, momentum=momentum) for _ in
        ...
        print('EIGWhitening by ZCA-------m_perGroup:' + str(self.num_channels) + '---nGroup:' + str(
