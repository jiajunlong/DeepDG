...
def add_arguments(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--dataset-root', metavar='PATH', default=os.path.expanduser('/home/lei/PycharmProjects/data/cifar10/'), type=utils.path,
...
def get_dataset_loader(args: argparse.Namespace, transforms=None, target_transform=None, train=True, use_cuda=True, random_label=False):
    ...
    if args.dataset == 'mnist':
        ...
        if len(args.im_size) == 0:
            args.im_size = (1, 28, 28)
        args.dataset_classes = 10
        dataset = torchvision.datasets.MNIST_RandomLabel(root, train, transforms, target_transform, download=False)
