...
__all__ = ['WideResNet_Stem64', 'WRNHeInit_Stem64_28_10', 'WRNHeInit_Stem64_40_10', 'WRNHeInit_Stem64_28_8', 'WRNHeInit_Stem64_40_8']
...
class WideResNet_Stem64(nn.Module):
    def __init__(self, depth=28, widen_factor=1, num_classes=10, dropout=0.0):
        super(WideResNet_Stem64, self).__init__()
...
def WRNHeInit_Stem64_28_10(**kwargs):
    return WideResNet_Stem64(28, 10, **kwargs)


def WRNHeInit_Stem64_40_10(**kwargs):
    return WideResNet_Stem64(40, 10, **kwargs)


def WRNHeInit_Stem64_28_8(**kwargs):
    return WideResNet_Stem64(28, 8, **kwargs)

def WRNHeInit_Stem64_40_8(**kwargs):
    return WideResNet_Stem64(40, 8, **kwargs)

if __name__ == '__main__':
    wrn = WideResNet_Stem64(28, widen_factor=10)
